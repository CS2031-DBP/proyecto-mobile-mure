...
import { Button, Text, TextInput, Avatar, Portal, Dialog } from "react-native-paper";
...
export default function EditProfile() {
	...
	const handleImagePicker = async () => {
		...
		if (!result.canceled) {
			...
			handleInputChange('profileImage', { uri: localUri, name: filename, type } as unknown as File);
		}
	};
	...
	return (
		<SafeAreaView style={{ flex: 1, padding: 20 }}>
			<ScrollView contentContainerStyle={{ alignItems: "center" }}>
				...
				<Button mode="contained" onPress={handleSave} style={{ width: "100%", padding: 8, marginTop: 16 }}>
					Save
				</Button>
				<Button mode="text" onPress={() => setIsModalVisible(true)} style={{ marginTop: 8 }}>
					Change Password
				</Button>
			</ScrollView>
