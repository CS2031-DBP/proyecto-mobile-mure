...
import { View, ScrollView, ActivityIndicator, Alert, Image } from 'react-native';
      ...
      <SafeAreaView style={{ flex: 1, padding: 10 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }}>
          <Image
            ...
            style={{ width: 60, height: 60, resizeMode: 'contain', borderRadius: 50, marginLeft: 10, marginVertical: 8}}
          />
          <Text style={{ fontSize: 35, fontWeight: "bold", fontFamily: "Roboto" }}>Mure</Text>
          <IconButton
            icon="magnify"
            size={30}
